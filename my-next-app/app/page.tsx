...
export default function Home() {
  return (
    <main className="w-full text-slate-50 overflow-hidden">

      {/* SECTION 1 — Spline Fullscreen */}
      <section className="relative h-screen w-full overflow-hidden">

        {/* Cover the Spline watermark */}
        <div className="absolute bottom-[23px] right-[20px] z-50 h-[45px] w-[180px] bg-slate-900/95 rounded-lg flex items-center justify-center shadow-lg">
          <span className="text-base font-semibold text-white/95">Mmr Statistics</span>
        </div>
