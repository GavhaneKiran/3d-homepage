  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 text-center">
      ...
      <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row justify-center gap-4 sm:gap-6">
        <button className="px-6 sm:px-8 py-2 rounded-lg bg-blue-600 text-base font-semibold hover:bg-blue-500 transition shadow-[0_0_20px_rgba(0,122,255,0.45)]">
          Book a Strategy Call
        </button>

        <button className="px-6 sm:px-8 py-2 rounded-lg border border-gray-600 text-base font-medium hover:bg-gray-800 transition">
          View Case Studies
        </button>
      </div>
    </div>
